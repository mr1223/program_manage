<template>
	<div class="edit">
		<quill-editor ref="myTextEditor" v-model="edit.content" :options="editorOption">
      	...
      	<input @change="uploadImg($event)" id="files" name="files" type="file" hidden />
...
<script>
	...
	import { domin,imageUpload } from 'common/path';
	export default {
		data(){
			return {
				'editorOption': {
