...
<script>
	...
	import { api_getProductList,api_showHideProduct,api_removeProduct,dominImg } from 'common/path';
	...
	export default {
	    ...
	    created(){
	    	...
	    	this.$http.post(api_getProductList,wind.stringify(obj))
			.then(res => {
				const data = res.data;
		...
		methods: {
      		look(e){
      			this.$router.push({path: '/infoProduct/' + e});
      		},
      		edit(e){
      			this.$router.push({path: '/addProduct/' + e});
      		},
      		showHide(e,ev,el){
      			var show = '';
      			var message = ''; 
      			...
      			this.$confirm('是否' + message + '?', '提示', {
			    	...
			    	this.$http.post(api_showHideProduct,wind.stringify(obj))
					.then(res => {
						const data = res.data;
      		...
      		del(e,el){
      			this.$confirm('是否删除?', '提示', {
			    	...
			    	this.$http.post(api_removeProduct,wind.stringify(obj))
					.then(res => {
						const data = res.data;
