<template>
	<div class="index">
		<el-content>
			<h3 class="addCarousel">新增荣誉资质</h3>
...
<script>
	...
	import { api_addHonor,api_getHonor,dominImg } from 'common/path';
	...
	export default {
		...
		methods: {
      		save(){
				...
				this.$http.post(api_addHonor,wind.stringify(obj))
				.then(res => {
					const data = res.data;
		    		if(data.code == 1){
