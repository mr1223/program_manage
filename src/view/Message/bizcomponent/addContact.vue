<template>
	<div class="index">
		<el-content>
			<h3 class="addCarousel">新增联系我们</h3>
...
<script>
	...
	import { api_addContact,api_getContact,dominImg } from 'common/path';
	...
	export default {
		...
		methods: {
      		save(){
				...
				this.$http.post(api_addContact,wind.stringify(obj))
				.then(res => {
					const data = res.data;
		    		if(data.code == 1){
