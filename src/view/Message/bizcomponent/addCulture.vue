<template>
	<div class="index">
		<el-content>
			<h3 class="addCarousel">新增企业文化</h3>
...
<script>
	...
	import { api_addCulture,api_getCulture,dominImg } from 'common/path';
	...
	export default {
		...
		methods: {
      		save(){
				...
				this.$http.post(api_addCulture,wind.stringify(obj))
				.then(res => {
					const data = res.data;
		    		if(data.code == 1){
